...
class ads_baner(models.Model):
    class baner_position(models.TextChoices):
    ...
    position = models.CharField(max_length=300, choices=baner_position.choices, verbose_name='جایگاه نمایشی')
    description = models.TextField(null=True, blank=True, verbose_name='توضیحات تبلیغ')
    image = models.ImageField(upload_to='images/ADS', verbose_name='تصویر تبلیغ')
    is_active = models.BooleanField(default=True, verbose_name='فعال / غیرفعال')
