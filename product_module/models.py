...
class product_visit(models.Model):
    ...
    ip = models.CharField(max_length=20, verbose_name='آی پی کاربر ')
    user = models.ForeignKey(User, null=True, blank=True, verbose_name='کاربر مشاهده کننده', on_delete=models.CASCADE)
...
class gallery_product(models.Model):
